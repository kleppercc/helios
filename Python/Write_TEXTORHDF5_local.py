...
ADGAIN = mdscon.get(Var0).data()
#print 'A/D RESOLU: %s [V/bit]' %ADGAIN

Var1=':DELAY'
#DELAY = mdsvalue(Var1)
DELAY = mdscon.get(Var1).data()

Var2 = ':FREQ'
#DIG_FREQ = mdsvalue(Var2)
DIG_FREQ = mdscon.get(Var2).data()
#print 'DEL_T:',DIG_FREQ

Var3 = ':NUM_SAMPLES'
#SAMPLES = mdsvalue(Var3)
SAMPLES = mdscon.get(Var3).data()
#print 'NUM_SAMPS:',SAMPLES

Var4 = ':TRIGGER'
#T_START = mdsvalue(Var4)
T_START = mdscon.get(Var4).data()
