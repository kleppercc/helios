c-------------------------------------------------------------------------------
c
c     Fast Time-Dependent Helium Line Ratio Subroutine (No Recombination)   
c
...
c
c-------------------------------------------------------------------------------
      subroutine tdmodel_fast(nexp,vb,ro,radius,I_667exp,I_706exp,
     &                        I_728exp,dI_667exp,dI_706exp,dI_728exp,
